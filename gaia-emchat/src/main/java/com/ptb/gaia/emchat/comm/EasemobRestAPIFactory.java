...
import com.ptb.gaia.emchat.api.RestAPIInvoker;
import com.ptb.gaia.emchat.comm.invoker.HttpClientRestAPIInvoker;
import com.ptb.gaia.emchat.comm.invoker.JerseyRestAPIInvoker;
...
public class EasemobRestAPIFactory {
	...
	private static final String BASE_PACKAGE = "com.ptb.gaia.emchat.api.impl";
