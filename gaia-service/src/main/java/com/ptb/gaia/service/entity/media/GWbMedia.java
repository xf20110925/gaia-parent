 ...
 *
 */
public class GWbMedia extends GWbMediaBasic implements Serializable{
    protected static final long FOURTEEN_DAY_TIME = 14 * 24 * 3600 * 1000;

    public GWbMedia() {

        this.wbStatisticsIn30Day = new WbMediaStatistics();
    ...
    public void reset() {
        ...
        if (this.getLatestArticle().getTime() < (getTimeAfterTondayMiddleNight(-8).getTime()) && this.getUpdateTime() < (getTimeAfterTondayMiddleNight(0).getTime())) {
        ...
        if (this.getLatestArticle().getTime() < (getTimeAfterTondayMiddleNight(-30).getTime()) && this.getUpdateTime() < (getTimeAfterTondayMiddleNight(0).getTime())) {
            this.wbStatisticsIn30Day.reset();
        }
     ...
     *
     */
    private WbMediaStatistics wbStatisticsIn30Day;
    ...
    public WbMediaStatistics getWbStatisticsIn30Day() {
        return wbStatisticsIn30Day;
    }

    public void setWbStatisticsIn30Day(WbMediaStatistics wbStatisticsIn30Day) {
        this.wbStatisticsIn30Day = wbStatisticsIn30Day;
    }
}